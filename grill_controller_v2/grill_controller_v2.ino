...
void loop() {
  ...
  printTemps(probe1temp,probe2temp);
...
void printTemps(float probetemp1, float probetemp2) {
  ...
  Serial.println(round(probetemp1));
  Serial.print("Probe 2 Temp: ");
  Serial.println(round(probetemp2));
  
  lcd.clear();
  lcd.setCursor(0,0);
  lcd.print("Probe 1 Temp: ");
  lcd.print(round(probetemp1));
  lcd.setCursor(0, 1);
  lcd.print("Probe 2 Temp: ");
  lcd.print(round(probetemp2));
